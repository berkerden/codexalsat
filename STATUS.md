...
- A8: temiz GitHub clone'unda kurulum betiği geçti. Kurtarma testleri ve
  [operasyon](docs/OPERATIONS.md) belgesi mevcut. Docker bu makinede yok.

Doğrulama: a22f104 üzerinde GitHub CI üç işi geçti; backend 83 test (SQLite +
PostgreSQL 16), frontend 3 test ve 1 tarayıcı akışı, lint/typecheck/build ve
...
Gerçek tarayıcıda BTC/SOL, periyot değişimi, sanal oturum başlatma/durdurma,
canlı mod kilidi kontrol edildi. Deneme paper oturumu durduruldu, açık pozisyon yok.
